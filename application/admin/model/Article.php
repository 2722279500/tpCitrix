...
class Article extends Model
{
    ...
    public function dataList()
    {
        ...
        if(!empty($get['article_cate_id']))
        {
            $where['article_cate_id'] = $get['article_cate_id'];
        }
	...
	public function add()
    {
        ...
        $validate = new \think\Validate([
            ['article_cate_id', 'require', '上级分类不能为空'],
        ...
        $data['article_cate_id'] = $post['article_cate_id'];
        ...
        if(true == Db::name("article")->insert($data))
        {
    ...
    public function edit()
    {
        ...
        if(true == Db::name("article")->where(['id'=>$post['id']])->update($data))
        {
            exit(json_encode(['code'=>1,'msg'=>'操作成功']));
        } 
        exit(json_encode(['code'=>0,'msg'=>'操作失败']));
    ...
    {
        $dataInfo = Db::name("article")->where(['id'=>$id])->find();
        return $dataInfo;
    }
    /**
     * [infoDelete 删除]
    ...
    {
        if(true == Db::name("article")->where(['id'=>$id])->delete())
        {
    ...
    public function batchDelete($delArray)
    {
        ...
        {
            Db::name("article")->where(['id'=>$delArray[$k1]])->delete();
        }
        exit(json_encode(['code'=>1,'msg'=>'删除成功']));
    }
    /**
