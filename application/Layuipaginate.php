...
{  
    ...
    protected function info(){  
        return "<p class='pageRemark'>共<b>" . $this->lastPage .  
            "</b>页<b>" . $this->total . "</b>条数据</p><form action='' method='get' class='pageRemark'>
            <input  type='text' name='page' autocomplete='off' class='pagination_input'> 
            <input type='submit' value='确定' class='pagination_submit'> 
            </form>";  
    }  
